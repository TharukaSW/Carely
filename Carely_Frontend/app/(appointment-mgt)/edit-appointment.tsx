...
export default function EditAppointmentScreen() {
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        setStatusMessage('Saving changes will reset this appointment to Pending so the doctor can review again.');
      } catch (e: any) {
  ...
  const onSave = async () => {
    try {
      ...
      Alert.alert('Updated', 'Appointment updated and set to Pending for approval.');
      router.back();
    } catch (e: any) {
